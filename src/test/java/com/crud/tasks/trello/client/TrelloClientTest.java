...
public class TrelloClientTest {
    ...
    public void shouldFetchTrelloBoards()throws URISyntaxException {
        ...
        assertEquals("test_boards", fetchedTrelloBoards.get(0).getName());
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("Test Task", "1","http://test.com", badgesDto);
        ...
        Assert.assertEquals(badgesDto, newCard.getBadges());
    }
